...
class StateWidget(QLabel):
    ...
    def mouseReleaseEvent(self, QMouseEvent):
        ...
        WindowEffect.setShadowEffect(menu.winId())
        action_list = []
    ...
    def __setQss(self):
        """ 设置层叠样式 """
        with open(r'resource\qss\text_edit_menu.qss', encoding='utf-8') as f:

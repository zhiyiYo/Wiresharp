...
class DialogMessageWidget(QWidget):
    ...
    def __init__(self, contactName: str, imagePath: str, message: str,  direction: str = 'left', parent=None):
        ...
        # 实例化小部件
        iconPath_dict = {
            'normal': r'app\resource\Image\my_dialog_interface\回应此消息_normal.png',
            'hover': r'app\resource\Image\my_dialog_interface\回应此消息_hover.png',
            'pressed': r'app\resource\Image\my_dialog_interface\回应此消息_pressed.png',
        }
    ...
    def __setQss(self):
        """ 设置层叠样式表 """
        with open(r'app\resource\qss\dialog_message_widget.qss', encoding='utf-8') as f:

...
from app.components.widgets.my_button import CircleButton
...
class DialogTextEdit(QTextEdit):
    ...
    def __init__(self, parent):
        ...
        iconPath_dict = {'normal': r'app\resource\Image\my_dialog_interface\笑脸_normal.png',
                         'hover': r'app\resource\Image\my_dialog_interface\笑脸_hover.png',
                         'pressed': r'app\resource\Image\my_dialog_interface\笑脸_pressed.png'}
    ...
    def __setQss(self):
        """ 设置层叠样式 """
        with open('app\resource\\qss\\dialog_text_edit.qss', encoding='utf-8') as f:

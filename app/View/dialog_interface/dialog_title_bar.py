...
from app.components.widgets.my_button import ThreeStatePushButton, CircleButton
...
class DialogTitleBar(QWidget):
    ...
    def __init__(self, contactName: str, parent=None):
        ...
        # 实例化小部件
        stateIconPath_dict = {
            'normal': r'app\resource\Image\my_dialog_interface\当前在线_normal.png',
            'hover': r'app\resource\Image\my_dialog_interface\当前在线_hover.png',
            'pressed': r'app\resource\Image\my_dialog_interface\当前在线_pressed.png'
        }
        mediaIconPath_dict = {
            'normal': r'app\resource\Image\my_dialog_interface\媒体库_normal.png',
            'hover': r'app\resource\Image\my_dialog_interface\媒体库_hover.png',
            'pressed': r'app\resource\Image\my_dialog_interface\媒体库_pressed.png'
        }
        callIconPath_dict = {
            'normal': r'app\resource\Image\my_dialog_interface\音频通话_normal.png',
            'hover': r'app\resource\Image\my_dialog_interface\音频通话_hover.png',
            'pressed': r'app\resource\Image\my_dialog_interface\音频通话_pressed.png'
        }
        createGroupIconPath_dict = {
            'normal': r'app\resource\Image\my_dialog_interface\新建群组_normal.png',
            'hover': r'app\resource\Image\my_dialog_interface\新建群组_hover.png',
            'pressed': r'app\resource\Image\my_dialog_interface\新建群组_pressed.png'
        }
    ...
    def __setQss(self):
        """ 设置层叠样式 """
        with open(r'app\resource\qss\dialog_title_bar.qss', encoding='utf-8') as f:

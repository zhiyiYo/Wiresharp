...
class TitleBar(QWidget):
    ...
    def __createButtons(self):
        ...
        self.minBt = ThreeStateToolButton(
            {'normal': r'app\resource\Image\title_bar\透明黑色最小化按钮_57_40.png',
             'hover': r'app\resource\Image\title_bar\绿色最小化按钮_hover_57_40.png',
             'pressed': r'app\resource\Image\title_bar\黑色最小化按钮_pressed_57_40.png'}, (57, 40), self)
        self.closeBt = ThreeStateToolButton(
            {'normal': r'app\resource\Image\title_bar\透明黑色关闭按钮_57_40.png',
             'hover': r'app\resource\Image\title_bar\关闭按钮_hover_57_40.png',
             'pressed': r'app\resource\Image\title_bar\关闭按钮_pressed_57_40.png'}, (57, 40), self)

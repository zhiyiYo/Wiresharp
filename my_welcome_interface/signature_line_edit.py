...
from widget.my_button import OpacityThreeStateToolButton
from widget.my_line_edit import LineEdit
...
class SignatureLineEdit(LineEdit):
    ...
    def __init__(self, text='', parent=None):
        ...
        self.editButton = OpacityThreeStateToolButton(
            r'resource\Image\welcome_interface\编辑个性签名.png', opacity_dict, (27, 28), self)
        self.resize(564, 50)
    ...
    def focusInEvent(self, e):
        ...
        self.editButton.setOpacityIcon(
            r'resource\Image\welcome_interface\确认个性签名.png')
        super().focusInEvent(e)

    def focusOutEvent(self, e):
        """ 更新图标并发送更新签名的信号 """
        self.editButton.setOpacityIcon(
            r'resource\Image\welcome_interface\编辑个性签名.png')

...
from widget.circle_widget import CircleWidget
...
class WelcomeInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.stateWidget = CircleWidget(
            r'resource\Image\welcome_interface\在线.png', 24, parent=self.headPortraitWidget)
        # 初始化窗口
        self.__initWidget()
    ...
    def __setQss(self):
        """ 设置层叠样式表 """
        with open(r'resource\qss\welcome_interface.qss', encoding='utf-8') as f:
